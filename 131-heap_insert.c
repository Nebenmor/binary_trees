...
heap_t *heap_insert(heap_t **root, int value)
{
	 ...
	 * For Example:
	 * Say there are 12 nodes in a complete tree, there are 5 leaves on
	...
	/* Flips the values with parent until parent value exceeds new value */
 ...
 * @tree: Is the tree to measure the size of
 *
