...
/**
 * successor - A function that get the next successor i mean the min 
...
/**
 *remove_type - Is a function that removes a node depending of its children
 *@root: node to remove
 ...
 * @value: Is a node with the value to remove
